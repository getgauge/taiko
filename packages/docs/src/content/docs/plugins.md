...
If you've [written your own plugin](/writing-plugins/) send a pull request to list it here. 
...
```
* Set the [`TAIKO_PLUGIN`](/configuring-taiko/#using-environment-variables) 
