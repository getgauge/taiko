...
This will download chromium browser and launch [Taiko's recorder](/record-and-run-tests/). You can also use `npx` to run existing taiko 
scripts for example
...
If everything looks fine, try [using the recorder](/record-and-run-tests/) to record a test.
