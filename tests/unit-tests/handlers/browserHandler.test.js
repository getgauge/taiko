...
describe("browserHandler", () => {
  let browserHandler;
  before(() => {
    browserHandler = rewire("taiko/lib/handlers/browserHandler");
  });

  after(() => {
    const createdSessionListener = browserHandler.__get__(
