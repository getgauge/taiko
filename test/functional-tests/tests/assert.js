...
const { title, text, textBox, toLeftOf  } = require('../../../lib/taiko');
...
step("Assert text <arg0> exists on the textArea. <arg1>", async function(arg0, arg1) {

  var valueis=await textBox(toLeftOf(_selectors.getElement(arg1))).value();
