 ...
 *
 * @returns {Promise<String>} - Object with the description of the action performed and the final URL.
 */
...
module.exports.metadata = {
    ...
    'Page actions': ['page', 'goto', 'reload', 'title', 'click', 'doubleClick', 'rightClick', 'hover', 'focus', 'write', 'upload', 'press', 'highlight', 'scrollTo', 'scrollRight', 'scrollLeft', 'scrollUp', 'scrollDown', 'screenshot'],
