 ...
 *
 * @example
 * Get me the cell at 1st row and 1st column
 * tableCell({row:"1", col:"1"}, "Table Caption")
 *
 * Get value of tableCell
 * tableCell({},{id:'myColumn'}).value()
 * Get Text
 * tableCell({row:"1",col:"3"}).text()
 *
 * Find the table with caption 'Table Caption', locate 2nd row and 3rd coloum cell.
 * highlight(tableCell({row:"2", col:"3"}, "Table Caption"))
 *
 * Locate table with caption 'Table Caption', then locate 2nd row and 2nd column cell,then
 * locate text 'Table Cell 2' above that particular cell
 ...
 *
 * Locate table with caption "Table Caption", then locate 4rth row and 1st col cell,
 * Then find link that is above the cell and click it!
 * click(link(above(tableCell({row:"4",col:"1"},"Table Caption"))))
 *
 * Locate table which is above 'Code', Locate 4rth row and 1st col cell,
 * locate link that is above the cell and highlight it!
