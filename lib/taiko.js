...
let chromeProcess, temporaryUserDataDir, page, network, runtime, input, client, dom, emulation, overlay, criTarget, currentPort, currentHost, rootId = null, headful;
 ...
 *       '--no-sandbox',
 *       '--no-zygote',
 *       '--single-process']}) - These are recommended args that has to be passed when running in docker
 * 
