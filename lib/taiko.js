...
function textBox(attrValuePairs, ...args) {
    ...
    if (!selector.attrValuePairs && !selector.label) get = async () => await handleRelativeSearch(await $$xpath('//input[@type="text" or @type="password"] | //textarea | //*[@contenteditable]'), selector.args);
        ...
        const getInputText = getElementGetter(selector,
            async () => await $$xpath(`//input[@type='text' or @type='password'][@id=(//label[contains(string(), ${xpath(selector.label)})]/@for)] | //label[contains(string(), ${xpath(selector.label)})]/input[@type='text' or @type='password']`),
        ...
        const getTextArea = getElementGetter(selector,
            ...
            '//textarea');
        const getContentEditable = getElementGetter(selector, async () => await $$xpath(`//*[@contenteditable][@id=(//label[contains(string(), ${xpath(selector.label)})]/@for)] | //label[contains(string(), ${xpath(selector.label)})]/*[@contenteditable]`), 
            '//*[@contenteditable]');
        get = async () => {
