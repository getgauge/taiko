 ...
 * })
 * 
 * @param {object} requestWithAction
 * @returns {object} Object with the description of the action performed.
 */
module.exports.intercept = async (requestWithAction) => {
    await networkHandler.addInterceptor(requestWithAction);
    return {description: `Interceptor added for ${requestWithAction.request.url}`};
};
