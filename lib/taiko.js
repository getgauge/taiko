 ...
 * @param {Object} browser - Puppeteer's [Browser](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md#class-browser) instance.
 * @param {Object} page - Puppeteer's [Page](https://github.com/GoogleChrome/puppeteer/blob/master/docs/api.md#class-page) instance.
 * @returns {Promise<Object>} - Object with the description of the action performed.
 */
module.exports.setup = (browser, page) => {
    if (!(browser instanceof Browser) || !(page instanceof Page))
        throw new Error('Invalid browser or page');
    b = browser;
    p = page;
    return { description: 'Browser and page initialized' };
};
...
async function click(selector, waitForNavigation = true, options = {}) {
    ...
    assertType(e, () => type !== 'file', 'Unsupported operation, use `attachFile` on file input field');
 ...
 * @returns {Promise<Object>} - Object with the description of the action performed.
 */
module.exports.attachFile = async (filepath, to) => {
    validate();
    ...
    await e.dispose();
    return { description: `Attached file ${filepath} to the ` + description(to, true) };
};
...
module.exports.metadata = {
    ...
    'Page actions': ['page', 'goto', 'reload', 'title', 'click', 'doubleClick', 'rightClick', 'hover', 'focus', 'write', 'attachFile', 'press', 'highlight', 'scrollTo', 'scrollRight', 'scrollLeft', 'scrollUp', 'scrollDown', 'screenshot'],
