...
module.exports.openBrowser = async (options = { headless: true }) => {
    ...
    if (options.emulateDevice) this.emulateDevice(options.emulateDevice);
    return { description: options.emulateDevice ? `Browser opened with viewport ${options.emulateDevice}`: 'Browser opened' };
};
