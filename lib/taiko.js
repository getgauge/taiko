 ...
 * @example
 * await checkBox($("/html/body/form/input[1]")).check()
 *
 * @param {Object} labelOrAttrValuePairs - Either the label (human-visible name) of the text field, pairs of attribute and value like {"id":"name","class":"class-name"} or xpath.
 * @param {Object} _options
 * @param {...relativeSelector} args Proximity selectors
...
module.exports.checkBox = (labelOrAttrValuePairs, _options, ...args) => {
  ...
  let dollarSelector;
  if (labelOrAttrValuePairs instanceof DollarWrapper) {
    dollarSelector = labelOrAttrValuePairs;
    labelOrAttrValuePairs = null;
  }
  return new CheckBoxWrapper(labelOrAttrValuePairs, dollarSelector, _options, ...args);
};
