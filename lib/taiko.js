...
const connect_to_cri = async (target, options = {}) => {
  ...
  var tgt = targetWSDebugUrl || target || (await targetHandler.createTarget(numRetries));
...
module.exports.closeIncognitoWindow = async (arg) => {
  ...
  await targetHandler.closeBrowserContext(targetHandler.register(arg).targetId);
...
const _switchContext = async (arg) => {
  ...
  if (targetId) {
    await targetHandler.switchBrowserContext(connect_to_cri, targetId);
  } else {
