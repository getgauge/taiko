...
module.exports.image = (attrValuePairs, _options = {}, ...args) => {
  ...
  const get = getElementGetter(
    selector,
    async () => await $$(`img[alt*="${selector.label}"]`, options.selectHiddenElements),
...
module.exports.button = (attrValuePairs, _options = {}, ...args) => {
  ...
  if (!selector.attrValuePairs && !selector.label) {
    ...
    const getByInput = getElementGetter(
      selector,
      async () =>
        await $function(getButtonElementWithLabel, selector.label, options.selectHiddenElements),
...
function fileField(attrValuePairs, _options = {}, ...args) {
  ...
  const get = getElementGetter(
    selector,
    async () =>
      await $function(getFileFieldElementWithLabel, selector.label, options.selectHiddenElements),
    'input[type="file"]',
    options.selectHiddenElements,
  );
...
function timeField(attrValuePairs, _options = {}, ...args) {
  ...
  const get = getElementGetter(
    selector,
    async () =>
      await $function(getTimeFieldElementWithLabel, selector.label, options.selectHiddenElements),
    'input[type="date" i],input[type="datetime-local" i],input[type="month" i],input[type="time" i],input[type="week" i]',
    options.selectHiddenElements,
  );
...
function range(attrValuePairs, _options = {}, ...args) {
  ...
  const get = getElementGetter(
    selector,
    async () =>
      await $function(getRangeElementWithLabel, selector.label, options.selectHiddenElements),
    'input[type="range"]',
    options.selectHiddenElements,
  );
...
function color(attrValuePairs, _options = {}, ...args) {
  ...
  const get = getElementGetter(
    selector,
    async () =>
      await $function(getColorElementWithLabel, selector.label, options.selectHiddenElements),
    'input[type="color"]',
    options.selectHiddenElements,
  );
...
function textBox(attrValuePairs, _options, ...args) {
  ...
  get = getElementGetter(
    selector,
    async () =>
      await $function(getTextBoxElementWithLabel, selector.label, options.selectHiddenElements),
...
function dropDown(attrValuePairs, _options, ...args) {
  ...
  const get = getElementGetter(
    selector,
    async () =>
      await $function(getDropDownElementWithLabel, selector.label, options.selectHiddenElements),
    'select',
    options.selectHiddenElements,
  );
...
module.exports.checkBox = (attrValuePairs, _options, ...args) => {
  validate();
  return createElementWrapper('checkBox', attrValuePairs, _options, ...args);
};
...
module.exports.radioButton = (attrValuePairs, _options, ...args) => {
  ...
  const get = getElementGetter(
    selector,
    async () =>
      await $function(getRadioButtonElementWithLabel, selector.label, options.selectHiddenElements),
    'input[type="radio" i]',
    options.selectHiddenElements,
  );
