...
function textBox(attrValuePairs, ...args) {
  ...
  const inputTypesExps = [
    'input[@type="text" or @type="password" or @type="search" or @type="number" or @type="email" or @type="tel" or @type="url" or @type="range" or @type="time" or @type="color" or @type="date" or @type="datetime-local" or @type="month" or @type="week"]',
    'input[not(@type)]',
  ];
  if (!selector.attrValuePairs && !selector.label) {
    get = async () =>
