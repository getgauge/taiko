...
module.exports.openIncognitoBrowser = async (
  ...
  descEvent.emit('success', 'Incognito Browser opened');
};
...
module.exports.closeIncognitoBrowser = async (
  ...
  _client = null;
  descEvent.emit('success', 'Incognito Browser closed');
};
...
module.exports.switchToIncognitoBrowser = async (
  ...
  descEvent.emit('success', 'Switched to Incognito Browser closed');
};
