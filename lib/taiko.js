 ...
 * @param {Object} options - { navigationTimeout:30000, headers:{'Authorization':'Basic cG9zdG1hbjpwYXNzd29y2A=='}} Default navigationTimeout is 30 seconds to override set options = {navigationTimeout:10000}, headers to override defaults.
 ...
 *
 * @example
 * await fileField('Please select a file:').value()
...
/**
 * This {@link selector} lets you identify an element with text. Looks for exact match if not found does contains and proximity selectors.
 *
 * @example
