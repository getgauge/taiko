...
/**
 * This {@link selector} lets you identify a text field(input (with type text, password, url, search, number, email, tel, textarea, contenteditable, range, color, date, datetime-local, month, time and week fields)
