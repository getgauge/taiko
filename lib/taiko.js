 ...
 *
 * @param {String} paramName - Specifies the name of the paramter you want to get (optional).  If not specified, returns a shallow copy of the full global configuration. 
*/
...
module.exports.metadata = {
  ...
  Helpers: ['evaluate', 'to', 'into', 'accept', 'dismiss', 'setConfig', 'getConfig', 'waitFor', 'repl'],
};
