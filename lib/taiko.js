 ...
 * @returns {Promise<object>} - Object with the description of the action performed
 */
module.exports.screenshot = async (selector, options = {}, ...args) => {
    validate();
...
module.exports.metadata = {
    'Browser actions': ['openBrowser', 'closeBrowser', 'client', 'switchTo', 'emulateDevice', 'setViewPort', 'openTab', 'closeTab', 'overridePermissions', 'clearPermissionOverrides', 'setCookie', 'clearBrowserCookies', 'deleteCookies', 'setLocation'],
