...
let chromeProcess, page, network, runtime, input, client, dom, criTarget,timedout,rootId;
...
module.exports.goto = async (url, options = { timeout: default_timeout }) => {
    ...
    if (timedout) {
        throw new Error(`Couldn't load url ${url} in ${options.timeout}ms. Please increase the timeout.`);
    }
