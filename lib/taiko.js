...
const { prepareParameters, desc, getElementGetter } = require('./elementWrapper/helper');
const { createElementWrapper } = require('./elementWrapper/elementWrapperFactory');
const {
  setConfig,
  getConfig,
  defaultConfig,
...
const calculateDestPosition = async (sourceElemobjectId, dest) => {
  if (isElement(dest)) {
    await scrollTo(dest);
    return await domHandler.boundingBoxCenter(dest.get());
  }
  const destPosition = await domHandler.calculateNewCenter(sourceElemobjectId, dest);
...
module.exports.$ = (attrValuePairs, _options = {}, ...args) => {
  validate();
  return createElementWrapper('CustomSelector', 'query', attrValuePairs, _options, ...args);
};
...
module.exports.image = (attrValuePairs, _options = {}, ...args) => {
  validate();
  return createElementWrapper('Image', 'alt', attrValuePairs, _options, ...args);
};
...
module.exports.link = (attrValuePairs, _options = {}, ...args) => {
  validate();
  return createElementWrapper('Link', 'text', attrValuePairs, _options, ...args);
};
...
module.exports.listItem = (attrValuePairs, _options = {}, ...args) => {
  validate();
  return createElementWrapper('ListItem', 'label', attrValuePairs, _options, ...args);
};
...
module.exports.button = (attrValuePairs, _options = {}, ...args) => {
  validate();
  return createElementWrapper('Button', 'label', attrValuePairs, _options, ...args);
};
...
function fileField(attrValuePairs, _options = {}, ...args) {
  validate();
  return createElementWrapper('FileField', 'label', attrValuePairs, _options, ...args);
}
...
function timeField(attrValuePairs, _options = {}, ...args) {
  validate();
  return createElementWrapper('TimeField', 'label', attrValuePairs, _options, ...args);
}
...
function range(attrValuePairs, _options = {}, ...args) {
  validate();
  return createElementWrapper('RangeType', 'label', attrValuePairs, _options, ...args);
}
...
function color(attrValuePairs, _options = {}, ...args) {
  ...
  return createElementWrapper('ColorField', 'label', attrValuePairs, _options, ...args);
}
  ...
  if (!selector.attrValuePairs && !selector.label) {
    ...
    get = async () =>
      await handleRelativeSearch(
        await $$(
          `table tbody tr:nth-child(${options.row}) td:nth-child(${options.col})`,
    ...
    const getTableCell = getElementGetter(
      ...
      async () =>
        await $function(
          ...
          { label: selector.label, row: options.row, col: options.col },
          options.selectHiddenElements,
        ),
      'table td',
    );
...
function textBox(attrValuePairs, _options, ...args) {
  validate();
  return createElementWrapper('TextBox', 'label', attrValuePairs, _options, ...args);
}
...
function dropDown(attrValuePairs, _options, ...args) {
  validate();
  return createElementWrapper('DropDown', 'label', attrValuePairs, _options, ...args);
}
...
module.exports.checkBox = (attrValuePairs, _options, ...args) => {
  validate();
  return createElementWrapper('Checkbox', 'label', attrValuePairs, _options, ...args);
};
...
module.exports.radioButton = (attrValuePairs, _options, ...args) => {
  validate();
  return createElementWrapper('RadioButton', 'label', attrValuePairs, _options, ...args);
};
...
function text(text, _options = {}, ...args) {
  validate();
  return createElementWrapper('Element', 'text', text, _options, ...args);
}
