...
module.exports.setNetwork = async (options = {}) => {
    await networkHandler.setNetworkEmulation('Network.emulateNetworkConditions', options, criTarget);
    return { description: `Set network emulation with values ${JSON.stringify(options)}` };
};
...
module.exports.metadata = {
    ...
    'Events': ['alert', 'prompt', 'confirm', 'beforeunload', 'intercept', 'setNetwork'],
