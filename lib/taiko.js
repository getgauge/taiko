 ...
 *
 * It exposes a method `elements()` which gives the actual list of element which can be used to loop over the elements.
 * It also exposes `element(index)` which gives the element for that index`
 ...
 * @property @private {function} elements - DOM element getter. Implicitly wait for the element to appears with timeout of 10 seconds. Returns element for that index from the list of element found.
 * @property @private {function} elements - DOM element getter. Implicitly wait for the element to appears with timeout of 10 seconds. Returns a list of element found.
 ...
 * @property {function} text - Gives innerText of the element found.
 * @property {function} getAttribute - Gives attribute value of the element found.
 *
 * @example
 * link('google').exists()
 * @example
...
/**
 * Element present on the web page. Extra methods are available based on the element type.
 *
 ...
 * @property {string} description - Describes the operation performed.
 * @property {function} text - Gives innerText of the first element found.
 * @property {function} getAttribute - Gives attribute value of the element found.
 *
 * @example
 * link('google').exists()
