...
const { determineWaitForNavigation } = require('./config');
const fs = require('fs');
const os = require('os');
 ...
 * @returns {Promise<Object>} - Object with the description of the action performed.
 */
module.exports.openTab = async (targetUrl, options = { navigationTimeout: default_timeout, waitForEvents: ['firstMeaningfulPaint'] }) => {
 ...
 */
module.exports.goto = async (url, options = { navigationTimeout: default_timeout, waitForEvents: ['firstMeaningfulPaint'] }) => {
    validate();
 ...
 * @returns {Promise<Object>} - Object with the description of the action performed and the final URL.
 */
module.exports.reload = async (url, options = { navigationTimeout: default_timeout, waitForEvents: ['firstMeaningfulPaint'] }) => {
    validate();
    // const promises = setNavigationPromises(options);
    options = setNavigationOptions(options);
    await doActionAwaitingNavigation(options, async () => {
 ...
 * @returns {Promise<Object>} - Object with the description of the action performed.
 */
module.exports.goBack = async (options = { navigationTimeout: default_timeout, waitForEvents: ['firstMeaningfulPaint'] }) => {
    validate();
    await _go(-1, options);
 ...
 * @returns {Promise<Object>} - Object with the description of the action performed.
 */
module.exports.goForward = async (options = { navigationTimeout: default_timeout, waitForEvents: ['firstMeaningfulPaint'] }) => {
    validate();
    await _go(+1, options);
