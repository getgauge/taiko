...
module.exports.openBrowser = async (options = { headless: true }) => {
    ...
    options.headless ? await connect_to_cri(): 
        await doActionAwaitingNavigation(setNavigationOptions({waitForEvents:['loadEventFired']}),connect_to_cri);
...
module.exports.metadata = {
    ...
    'Helpers': ['evaluate', 'intervalSecs', 'timeoutSecs', 'to', 'into', 'waitFor', 'accept', 'dismiss', 'setConfig', 'repl'],
