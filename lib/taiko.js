 ...
 * @returns {Promise<Object>} - Object with the description of the action performed.
 */
module.exports.doubleClick = async (selector, waitForNavigation = false) => {
 ...
 *
 * @param {selector|string} selector - A selector to search for element to hovers. If there are multiple elements satisfying the selector, the first will be hovered.
 * @returns {Promise<Object>} - Object with the description of the action performed.
 */
