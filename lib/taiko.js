 ...
 * setGeolocation({ latitude: 27.1752868, longitude: 78.040009, accuracy:20 })
 * 
 * @param {object} - { latitude: 27.1752868, longitude: 78.040009, accuracy:20 }
 * @returns {Promise<Object>} - Object with the description of the action performed
 */
module.exports.setGeolocation = async(options) => {
    await emulationHandler.setGeolocation(options);
...
module.exports.metadata = {
    'Browser actions': ['openBrowser', 'closeBrowser', 'client', 'switchTo', 'setViewPort', 'openTab', 'closeTab', 'overridePermissions', 'clearPermissionOverrides', 'setCookie', 'clearBrowserCookies', 'deleteCookies', 'setGeolocation'],
