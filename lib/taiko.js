...
module.exports.screenshot = async (selector, options = {}) => {
    validate();
    console.log('----', options);
    pageHandler.captureScreenshot(domHandler, selector, options);
    console.log(options);
    descEvent.emit('success', 'Screenshot is created at ' + options.encoding ? options.encoding : options.path);
};
