 ...
 *
 * @example
 * // Note: element.style only returns inline style and does not returns style defined in a css file.
 * await evaluate(link("something"), (element) => element.style.backgroundColor)
 *
 * await evaluate((rootHtmlElement) => {
 *      rootHtmlElement.getElementsByTagName('body')[0].style.backgroundColor = 'red';
 * })
 *
