 ...
 * 
 * @example
 * intercept({url:"https://taiko.gauge.org/assets/css/pilcrow.css",method:'GET'},{errorCode:'Aborted'})
 * 
 ...
 * @param {object} override - values to override request (url, method, post-data, headers) or mock-response (errorCode, status, headers, contentType, body)
 */
module.exports.intercept = async (requestIdentifier,override) => {
    networkHandler.addInterceptor(requestIdentifier,override);
    return {description: `Interceptor added for ${requestIdentifier.url}`};
};
