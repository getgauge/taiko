...
module.exports.metadata = {
    ...
    'Page actions': ['page', 'goto', 'reload', 'click', 'doubleClick', 'rightClick', 'hover', 'focus', 'write', 'upload', 'press', 'highlight', 'scrollTo', 'scrollRight', 'scrollLeft', 'scrollUp', 'scrollDown', 'screenshot'],
