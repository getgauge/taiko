...
const {match,$$,$$xpath,initElementSearch,isSelector,elements,element,isElementVisible} = require('./elementSearch');
    ...
    return new Promise(async function connect(resolve) {
        try {
            ...
            await cri({ target, local: localProtocol }, async (c) => {
                ...
                initElementSearch(runtimeHandler,handleRelativeSearch,descEvent);
