...
const handleNavigation = async (url) => {
    ...
    const handleRequest =  (request) => {
        ...
        let urlToNavigate = nodeURL.parse(url);
        requestUrl = nodeURL.parse(requestUrl);
        if(urlToNavigate.protocol === 'file:'){
            urlToNavigate = nodeURL.fileURLToPath(urlToNavigate.href);
            requestUrl = nodeURL.fileURLToPath(requestUrl.href);
        } else {
            requestUrl = handleUrlRedirection(requestUrl.href);
            urlToNavigate = handleUrlRedirection(urlToNavigate.href);
        }   
    ...
    xhrEvent.removeListener('responseRecevied',handleResponseStatus);
