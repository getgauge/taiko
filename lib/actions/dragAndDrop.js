...
const dragAndDrop = async (source, destination, options) => {
  ...
  await doActionAwaitingNavigation(options, async () => {
    ...
    sourceDraggable
      ? await dragAndDropHTML5Element(sourcePosition, destPosition, sourceElem.get(), options.delay)
...
const dragAndDropHTML5Element = async (sourcePosition, destPosition, sourceElementObjectId, delay) => {
