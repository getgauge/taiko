...
class ElementWrapper {
  ...
  /**
   * @description Gets the {@link https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/innerText|innerText} of the element
   * @returns {string} {@link https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/innerText|innerText} of the element
   */
  async text() {
