const {xpath,assertType,getIfExists,isString} = require('./helper');
...
function match(text, ...args) {
    ...
    return { get: getIfExists(get), description: `Element matching text "${text}"`};
}
...
module.exports = {match,$$xpath,$$,element,elements,isSelector,isElementVisible};
