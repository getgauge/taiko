        ...
        if (childNodes.length) {
          for (let childNode of childNodes) {
            ...
            if (
              exactMatch &&
              ((childNode.textContent &&
                childNode.textContent.match(searchText) &&
                childNode.textContent.match(searchText)[0] === childNode.textContent) ||
                (!isRegex(searchText) && nodeTextContent === searchText))
            ) {
              return true;
            }
            if (
              (childNode.textContent && childNode.textContent.match(searchText)) ||
        ...
        while ((node = iterator.nextNode())) {
          ...
          if (node.nodeName === 'INPUT') {
            ...
            if (
              ...
              (node.value &&
                node.value.match(searchText) &&
                node.value.match(searchText)[0] === node.value) ||
              ...
              !args.exactMatch &&
              (node.value.match(searchText) ||
                (!isRegex(searchText) && nodeValue.includes(searchText)) ||
                (['submit', 'reset'].includes(node.type.toLowerCase()) &&
          ...
          if (
            ...
            (node.textContent &&
              node.textContent.match(searchText) &&
              node.textContent.match(searchText)[0] === node.textContent) ||
            ...
            (node.textContent && node.textContent.match(searchText)) ||
            (!isRegex(searchText) && !args.exactMatch && nodeTextContent.includes(searchText))
          ) {
